...
Parse.prototype = {
  ...
  updateInstallation: function(objectId, data, callback) {
    parseRequest.call(this, 'PUT', '/1/installations/' + objectId, data, callback);
  },
  ...
  findManyInstallations: function(query, callback) {
    parseRequest.call(this, 'GET', '/1/installations?', { where: JSON.stringify(query) }, callback);
  },
